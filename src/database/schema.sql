...
(1, 'လက်ဘက်ထမင်း', 2500,'/menu_img/laphat-1.jpg'),
(1, 'ဆန်ပြား', 2000,'/menu_img/san-pyar-1.jpg'),
(1, 'ရှမ်းခေါက်ဆွဲ', 2000,'/menu_img/shan-1.jpg'),
(1, 'လက်ဘက်သုပ်', 2500,'/menu_img/laphat-thoke-1.jpg'),
(1, 'ပက်ရှူးထမင်း', 3000,'/menu_img/pat-shuu-1.jpg'),
(1, 'အကင်ထောင်း', 3500,'/menu_img/a-kin-1.jpg'),
(1, 'အာလူးထမင်းကြော်', 3000,'/menu_img/arrluu-kyaw-1.jpg'),
...
(1, 'dragon fruit juice', 3500,'/menu_img/dragon-1.jpg'),

(2, 'အာလူးထမင်းကြော်', 3000,'/menu_img/arrluu-kyaw-2.jpg'),
(2, 'အကင်ထောင်း', 3500,'/menu_img/a-kin-2.jpg'),
(2, 'ဆန်ပြား', 2000,'/menu_img/san-pyar-2.jpg'),
(2, 'ထမင်းဆီစမ်း', 1200,'/menu_img/see-san-2.jpg'),
(2, 'လက်ဘက်ထမင်း', 2500,'/menu_img/laphat-2.jpg'),
(2, 'ရှမ်းခေါက်ဆွဲ', 2000,'/menu_img/shan-2.jpg'),
(2, 'လက်ဘက်သုပ်', 2500,'/menu_img/laphat-thoke-2.jpg'),
(2, 'ပက်ရှူးထမင်း', 3000,'/menu_img/pat-shuu-2.jpg'),
(2, 'ပင်လယ်စာထမင်းကြော်', 3000,'/menu_img/sea-kyaw-1.jpg'),
(2, 'ကဗလာသီး', 3500,'/menu_img/gabalar-1.jpg'),
(2, 'ကော်ဖီ', 1500,'/menu_img/coffee-2.jpg'),
(2, 'Pineapple juice', 3500,'/menu_img/pineapple-2.jpg'),
(2, 'dragon fruit juice', 3500,'/menu_img/dragon-3.jpg'),

(3, 'ပင်လယ်စာထမင်းကြော်', 3000,'/menu_img/sea-kyaw-2.jpg'),
...
(3, 'ကျောက်ပွင့်သုပ်', 3000,'/menu_img/kyout-5.jpg'),
(3, 'လက်ဘက်ထမင်း', 2000,'/menu_img/laphat-3.jpg'),
(3, 'ကော်ဖီ', 1500,'/menu_img/coffee-3.jpg'),
(3, 'ရှမ်းခေါက်ဆွဲ', 2000,'/menu_img/shan-3.jpg'),
(3, 'လက်ဘက်သုပ်', 2500,'/menu_img/laphat-thoke-3.jpg'),
(3, 'ပက်ရှူးထမင်း', 3000,'/menu_img/pat-shuu-1.jpg'),
...
(3, 'dragon fruit juice', 3500,'/menu_img/dragon-2.jpg'),

(4, 'မာလာမောက်ချိုက်', 3500,'/menu_img/malar-mout-2.jpg'),
(4, 'မြေအိုးမြှီးရှည်', 4000,'/menu_img/pot-mee-2.jpg'),
(4, 'ထမင်းဆီစမ်း', 1000,'/menu_img/see-san-4.jpg'),
(4, 'ရှမ်းခေါက်ဆွဲ', 2000,'/menu_img/shan-4.jpg'),
(4, 'ကျောက်ပွင့်သုပ်', 2500,'/menu_img/kyout-4.jpg'),
(4, 'လက်ဘက်သုပ်', 2500,'/menu_img/laphat-thoke-4.jpg'),
(4, 'ငါးသေတ္တာထမင်းကြော်', 3000,'/menu_img/fish-2.jpg'),
(4, 'ပင်လယ်စာထမင်းကြော်', 3000,'/menu_img/sea-kyaw-3.jpg'),
(4, 'ဖက်ထုပ်ကြော်', 2500,'/menu_img/phat-kyaw-4.jpg'),
(4, 'ဆိတ်ထောင်းထမင်း', 2500,'/menu_img/sate-1.jpg'),
(4, 'ပြောင်းဖူးထမင်းကြော်', 3000,'/menu_img/corn-kyaw-2.jpg'),
...
(5, 'ပြောင်းဖူးထမင်းကြော်', 3000,'/menu_img/corn-kyaw-3.jpg'),
(5, 'မြေအိုးမြှီးရှည်', 4000,'/menu_img/pot-mee-1.jpg'),
(5, 'လက်ဘက်သုပ်', 2500,'/menu_img/laphat-thoke-5.jpg'),
(5, 'ကျောက်ပွင့်သုပ်', 3000,'/menu_img/kyout-1.jpg'),
(5, 'ငါးသေတ္တာထမင်းကြော်', 3000,'/menu_img/fish-1.jpg'),
(5, 'မုန့်တီသုပ်', 2000,'/menu_img/mont-ti-1.jpg'),
(5, 'မာလာထမင်းကြော်', 3000,'/menu_img/malar-kyaw-1.jpg'),
(5, 'ဆိတ်ထောင်းထမင်း', 2500,'/menu_img/sate-2.jpg'),
(5, 'ဖက်ထုပ်ပေါင်း', 2500,'/menu_img/phat-htoke-pound-1.jpg'),
(5, 'သီးစုံထမင်းကြော်', 2500,'/menu_img/tee-sone-1.jpg'),
(5, 'ရှောက်သီးသုပ်', 3000,'/menu_img/shout-thoke-1.jpg'),
(5, 'မာလာရှမ်းကော', 8500,'/menu_img/mar-shan-1.jpg'),
...
(6, 'မာလာရှမ်းကော', 10000,'/menu_img/mar-shan-2.jpg'),
(6, 'ဖက်ထုပ်ပေါင်း', 3000,'/menu_img/phat-htoke-pound-2.jpg'),
(6, 'ရှောက်သီးသုပ်', 2500,'/menu_img/shout-thoke-2.jpg'),
(6, 'ကျောက်ပွင့်သုပ်', 3000,'/menu_img/kyout-2.jpg'),
(6, 'တုန်ယမ်းထမင်းကြော်', 3000,'/menu_img/tone-yan-4.jpg'),
(6, 'ထမင်းကြော်', 2000,'/menu_img/hta-min-kyaw-1.jpg'),
(6, 'မာလာထမင်းကြော်', 3000,'/menu_img/malar-kyaw-2.jpg'),
(6, 'ကြက်ဥထမင်းလိပ်', 2500,'/menu_img/egg-late-1.jpg'),
(6, 'မုန့်တီသုပ်', 2000,'/menu_img/mont-ti-2.jpg'),
...
(7, 'တုန်ယမ်းထမင်းကြော်', 2500,'/menu_img/tone-yan-2.jpg'),
(7, 'ကျောက်ပွင့်သုပ်', 3000,'/menu_img/kyout-3.jpg'),
(7, 'မာလာထမင်းကြော်', 3500,'/menu_img/malar-kyaw-3.jpg'),
(7, 'မုန့်တီသုပ်', 2500,'/menu_img/mont-ti-3.jpg'),
...
(7, 'ဂျင်းသုပ်', 3000,'/menu_img/jin-thoke-1.jpg'),
(7, 'ကြာဇံကြော်', 3000,'/menu_img/kyar-san-1.jpg'),
...
(8, 'သီးစုံထမင်းကြော်', 3000,'/menu_img/tee-sone-2.jpg'),
(8, 'ဆိတ်ထောင်းထမင်း', 2500,'/menu_img/sate-3.jpg'),
(8, 'ခေါက်ဆွဲကြော်', 3500,'/menu_img/kyout-swe-2.jpg'),
(8, 'ဖက်ထုပ်ပေါင်း', 3500,'/menu_img/phat-htoke-pound-3.jpg'),
(8, 'ဂျင်းသုပ်', 2500,'/menu_img/jin-thoke-2.jpg'),
(8, 'ကြာဇံကြော်', 2500,'/menu_img/kyar-san-2.jpg'),
(8, 'ပြောင်းဖူးထမင်းကြော်', 2500,'/menu_img/corn-kyaw-1.jpg'),
(8, 'တုန်ယမ်းထမင်းကြော်', 3000,'/menu_img/tone-yan-3.jpg'),
(8, 'မာလာထမင်းကြော်', 3000,'/menu_img/malar-kyaw-4.jpg'),
(8, 'အာလူးမာလာ', 3500,'/menu_img/arrluu-malar-2.jpg'),
(8, 'မုန့်တီသုပ်', 2500,'/menu_img/mont-ti-4.jpg'),
